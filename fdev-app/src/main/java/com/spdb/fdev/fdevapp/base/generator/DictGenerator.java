package com.spdb.fdev.fdevapp.base.generator;
...
public class DictGenerator {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            File dirFile = null;
            if (new File(dir + File.separator + rep).exists()) {
                dirFile = new File(dir + File.separator + rep);
            }
            ...
            prt.println("package com.spdb.fdev.fdevapp.base.dict;");
            prt.println("/**");
