...
<head>
    ...
    <style>
        ...
        /*--header start here--*/
        .newsletter {
            <#--background: url(${fdev_domain}}/fconfigci/banner.png) no-repeat;-->
...
<div class="newsletter">
    <div class="newsletter-main">
        ...
        <div class="design">
            <img src="${fdev_domain}/fconfigci/design.png"/>
        </div>
        <br><br>
    ...
    <div class="copy-right" style="margin-left: 5%;margin-right: 5%">
        <p style="color: black;">提示：请不要对此邮件直接回复，系统看不懂您的回信^_^。如果您有建议或意见，请回复
            <a href="mailto:${send_email}" style="text-decoration:none; color:blue;">${send_email}</a></p>
    </div>
</div>
