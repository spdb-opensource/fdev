...
public class Constant {
     ...
     * 新增优化需求验证
     */
    public static final String POM_PATTERN = "([1-9]\\d*).([0-9]|([1-9]\\d*)).([0-9]|([1-9]\\d*))";

    public static final String PATTERN = "(?!0)(\\d{1,})\\.((?!0)\\d{2}|\\d{1})\\.((?!0)\\d{2}|\\d{1})";

    /**
     * 录入和新增组件时验证是否为数字字符下划线
     */
    public static final String COMPONENT_PATTERN = "[\\w.-]+";

    /**
     * merge状态 open
     */
    public static final String MERGE_STATE_OPENED="opened";
     ...
     * merge状态 pending
     */
    public static final String PIPELINE_STATUS_PENDING="pending";
