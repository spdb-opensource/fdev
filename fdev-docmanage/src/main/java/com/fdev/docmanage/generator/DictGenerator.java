package com.fdev.docmanage.generator;
...
public class DictGenerator {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String dictName = "/" + com.fdev.docmanage.generator.DictGenerator.class.getName().replace('.', '/');
            java.net.URL outUrl1 = com.fdev.docmanage.generator.DictGenerator.class.getResource(dictName + ".class");
            ...
            PrintStream prt = new PrintStream(new java.io.FileOutputStream(new File(dirFile, targedFile)));
            ...
            prt.println("package com.fdev.docmanage.dict;");
            prt.println("/**");
