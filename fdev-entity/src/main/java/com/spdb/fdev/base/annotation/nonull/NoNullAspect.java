...
public class NoNullAspect {
    ...
    @Pointcut("@annotation(com.spdb.fdev.base.annotation.nonull.NoNull)")
    ...
    public Object around(ProceedingJoinPoint pjp) throws Throwable {
        ...
        com.spdb.fdev.base.annotation.nonull.NoNull noNull = method.getAnnotation(com.spdb.fdev.base.annotation.nonull.NoNull.class);
    ...
    private static void checkData(String filedName, Object parameter) throws Exception {
        ...
        if (index > 0) {
            ...
            Object checkData = CommonUtil.returnObjByKey(parameter, key);
    ...
    public static void checkData(Object parameter, String filedName) throws Exception {
        ...
        if (parameter instanceof Map) {
            ...
            if (CommonUtil.isNullOrEmpty(map.get(filedName)))
                throw new FdevException(ErrorConstants.PARAM_ERROR, new String[]{filedName + "为空"});
            ...
            throw new FdevException(ErrorConstants.PARAM_ERROR, new String[]{filedName + "为空"});
        } else if (parameter instanceof Integer && CommonUtil.isNullOrEmpty(parameter)) {
            throw new FdevException(ErrorConstants.PARAM_ERROR, new String[]{filedName + "为空"});
        } else {
