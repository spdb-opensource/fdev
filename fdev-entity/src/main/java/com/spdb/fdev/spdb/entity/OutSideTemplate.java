...
public class OutSideTemplate implements Serializable {
    ...
    public OutSideTemplate(ObjectId _id, String projectId, List<Map<String, String>> variables, String opno,
    ...
    public String toString() {
        return "OutSideTemplate [_id=" + _id + ", projectId=" + projectId + ", variables=" + variables + ", opno="
