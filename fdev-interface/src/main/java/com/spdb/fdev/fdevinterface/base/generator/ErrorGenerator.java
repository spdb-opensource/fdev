package com.spdb.fdev.fdevinterface.base.generator;
...
public class ErrorGenerator {
    ...
    public static void main(String[] args) {
        ...
        String dictName = "/" + com.spdb.fdev.fdevinterface.base.generator.ErrorGenerator.class.getName().replace('.', '/');
        java.net.URL outUrl1 = com.spdb.fdev.fdevinterface.base.generator.ErrorGenerator.class.getResource(dictName + ".class");
        String outUrl = "";
        try {
        ...
        if (tmpPath.contains(tmp)) {
            dir = tmpPath.substring(0, tmpPath.indexOf(tmp)) + Constants.SLASH;
        }
        File dirFile = null;
        ...
        try (PrintStream prt = new PrintStream(new java.io.FileOutputStream(new File(dirFile, targedFile)));
            ...
            prt.println(" */ ");
            prt.println("package com.spdb.fdev.fdevinterface.base.dict;");
