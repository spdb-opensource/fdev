...
@Document(collection = Dict.INTERFACE_SOAP_RELATION)
public class SoapRelation implements Serializable {

    private static final long serialVersionUID = 8035811513957803277L;
