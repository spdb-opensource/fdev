 ...
 */
@Document(collection = Dict.INTERFACE_TOTAL_DAT)
public class TotalDat implements Serializable {

    private static final long serialVersionUID = 7236684325685414740L;
