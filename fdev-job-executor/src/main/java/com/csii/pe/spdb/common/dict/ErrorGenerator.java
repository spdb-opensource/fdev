package com.csii.pe.spdb.common.dict;
...
public class ErrorGenerator {
	...
	public static void main(String[] args) {
		...
		String fileName = "/config/i18n/error_mapping.properties";
		String targetName1 = "/config/i18n/errmsg_zh_CN.properties";
		String targetName = "ErrorConstants.java";
		try {
			System.out.println("begin generated the ErrorConstants.java file  .....");
			InputStream in = fp.getClass().getResourceAsStream(fileName);
			fp.load(in);
			in.close();
			...
			String targetFile = dictName + targetName;
			System.out.println("the targetFile is: " + targetFile);
			...
			PrintStream prt = new PrintStream(new java.io.FileOutputStream(
					new File(dirFile, targetFile)));
			...
			prt.println(" */ ");
			prt.println("package com.csii.pe.spdb.common.dict;");

			prt.println("/**");
			prt.println(" * 个人网银系统错误字典文件");
