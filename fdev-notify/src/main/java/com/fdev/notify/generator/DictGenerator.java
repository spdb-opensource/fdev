package com.fdev.notify.generator;
...
public class DictGenerator {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String dictName = "/" + com.fdev.notify.generator.DictGenerator.class.getName().replace('.', '/');
            java.net.URL outUrl1 = com.fdev.notify.generator.DictGenerator.class.getResource(dictName + ".class");
            ...
            prt.println("package com.fdev.notify.dict;");
            prt.println("/**");
