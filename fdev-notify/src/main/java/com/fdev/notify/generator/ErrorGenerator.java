...
public class ErrorGenerator {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String dictName = "/"
					+ com.fdev.notify.generator.ErrorGenerator.class.getName().replace('.', '/');

			java.net.URL outUrl1 = com.fdev.notify.generator.ErrorGenerator.class.getResource(dictName
					+ ".class");
