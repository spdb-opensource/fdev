package com.spdb.fdev.codeReview.base.generator;
...
public class DictGenerator {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            prt.println("package com.spdb.fdev.codeReview.base.dict;");
            prt.println("/**");
            ...
            for (Iterator i = set.iterator(); i.hasNext(); ) {
                ...
                String value = new String(fp.getProperty(name).getBytes("utf-8"), "UTF-8");
