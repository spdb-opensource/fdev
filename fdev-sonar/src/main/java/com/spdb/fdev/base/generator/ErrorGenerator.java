package com.spdb.fdev.base.generator;
...
public class ErrorGenerator {
    ...
    public static void main(String[] args) {
        ...
        String dictName = "/" + com.spdb.fdev.base.generator.ErrorGenerator.class.getName().replace('.', '/');
        java.net.URL outUrl1 = com.spdb.fdev.base.generator.ErrorGenerator.class.getResource(dictName + ".class");
        String outUrl = "";
        try {
        ...
        try (PrintStream prt = new PrintStream(new java.io.FileOutputStream(new File(dirFile, targedFile)));
            ...
            prt.println(" */ ");
            prt.println("package com.spdb.fdev.base.dict;");
