package com.spdb.fdev.fdevtask.base.generator;
...
public class DictGenerator {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String dictName = "/" + com.spdb.fdev.fdevtask.base.generator.DictGenerator.class.getName().replace('.', '/');
            java.net.URL outUrl1 = com.spdb.fdev.fdevtask.base.generator.DictGenerator.class.getResource(dictName + ".class");
            ...
            prt.println("package com.spdb.fdev.fdevtask.base.dict;");
            prt.println("/**");
            prt.println(" * fdev-fask 字典文件");
