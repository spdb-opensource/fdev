...
public class ErrorGenerator {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String dictName = "/"
					+ com.spdb.fdev.fdevtask.base.generator.ErrorGenerator.class.getName().replace('.', '/');
			java.net.URL outUrl1 = com.spdb.fdev.fdevtask.base.generator.ErrorGenerator.class.getResource(dictName
					+ ".class");
