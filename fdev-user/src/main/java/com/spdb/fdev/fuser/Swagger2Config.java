...
/**
 * Swagger2
 * 访问地址http://localhost:8080/fuser/swagger-ui.html
 * */
...
public class Swagger2Config {
	...
	public Docket api() {
		...
		return new Docket(DocumentationType.SWAGGER_2)
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.spdb.fdev.fuser"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("　　　　　　　　　　　　　　　fdev-user-api文档")
				.version("1.0")
				.build();
	}
}
