package com.spdb.fdev.fuser.base.generator;
...
public class ErrorGenerator {
	...
	public static void main(String[] args) {
		...
		String targetName2 = "/config/errmsg.properties";
		...
		try {
			...
			PrintStream prt3 = new PrintStream(new java.io.FileOutputStream(new File("src/main/resources",targetName2)));
			...
			prt.println(" */ ");
			prt.println("package com.spdb.fdev.fuser.base.dict;");
