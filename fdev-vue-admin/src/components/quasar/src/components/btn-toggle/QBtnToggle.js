...
export default Vue.extend({
  ...
  computed: {
    ...
    btnOptions() {
      const mergeOption = (opt, key) =>
        opt[key] === void 0 ? this[key] : opt[key];
      ...
      return this.options.map((opt, i) => ({
        ...
        options: {
          ...
          class: {
            'q-no-leftborder': i !== 0,
            'q-no-rightborder': i === this.activeIndex - 1,
            ...opt.class
          },
          style: { width: `${this.btnWidth}px`, ...opt.style },
          on: {
            ...this.qListeners,
          ...
          props: {
            ...
            dense: this.dense,
            // normal: opt.value !== this.value,
            normal: i !== this.activeIndex,
