  ...
  render(h) {
    ...
    this.ficon !== void 0 &&
      inner.push(
        h(fIcon, {
          // staticClass: 'q-mr-sm',
          class: [this.flat ? 'q-mr-xs' : 'q-mr-xs'],
    ...
    this.hasLabel === true &&
      inner.push(
        h(
          'span',
          {
            staticClass: this.menu
              ? 'block q-btn--menu--label text-ellipsis text-no-wrap'
              : 'block text-no-wrap'
          },
          [this.label]
        )
        ...
        h(
          ...
          [
            h('span', {
              ...
              class:
                this.darkPercentage === true ? 'q-btn__progress--dark' : '',
    ...
    child.push(
      h(
        'span',
        {
          ...
          attrs: {
            title: this.hasTip ? this.label : null
          }
        },
        [
          h(
            ...
            {
              staticClass:
                'q-btn__content text-center col items-center no-wrap q-anchor--skip',
