...
export default Vue.extend({
  ...
  computed: {
    classes() {
      const text =
        this.outline === true ? this.color || this.textColor : this.textColor;
      ...
      return {
        ...
        'q-chip--clickable cursor-pointer non-selectable q-hoverable': this
          .isClickable,
    ...
    isClickable() {
      return (
        this.disable === false &&
        (this.clickable === true || this.selected !== null)
      );
    },
  ...
  methods: {
    ...
    __getContent(h) {
      ...
      this.isClickable === true &&
        child.push(h('div', { staticClass: 'q-focus-helper' }));
      ...
      const label =
        this.label !== void 0
          ? [h('div', { staticClass: 'ellipsis', attrs: { title: this.label } }, [this.label])]
          : void 0;
      ...
      this.removable === true &&
        child.push(
          h(FIcon, {
            staticClass: 'q-chip__icon q-chip__icon--remove cursor-pointer text-black-0',
            props: { name: 'close' },
            attrs: {
              ...this.attrs,
              width: 7,
