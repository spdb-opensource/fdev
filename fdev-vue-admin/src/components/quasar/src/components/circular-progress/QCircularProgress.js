...
export default Vue.extend({
  ...
  computed: {
    ...
    strokeDashOffset() {
      const progress =
        1 - (this.normalizedValue - this.min) / (this.max - this.min);
    ...
    attrs() {
      return {
        ...
        'aria-valuenow':
          this.indeterminate === true ? void 0 : this.normalizedValue
      };
    }
  },
  ...
  render(h) {
    ...
    this.centerColor !== void 0 &&
      this.centerColor !== 'transparent' &&
      svgChild.push(
        h('circle', {
