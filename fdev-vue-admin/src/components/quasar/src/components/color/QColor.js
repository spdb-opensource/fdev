...
export default Vue.extend({
      ...
      topView:
        this.formatModel === 'auto'
          ? this.value === void 0 ||
            ...
            ? 'hex'
            : 'rgb'
          : this.formatModel.startsWith('hex')
          ? 'hex'
          : 'rgb',
  ...
  computed: {
    ...
    headerClass() {
      const light =
        this.model.a !== void 0 && this.model.a < 65
          ? true
  ...
  methods: {
    __getHeader(h) {
      return h(
        ...
        {
          staticClass:
            'q-color-picker__header relative-position overflow-hidden'
        },
        [
          ...
          h(
            ...
            [
              ...
              h(
                ...
                {
                  staticClass:
                    'q-color-picker__header-banner row flex-center no-wrap'
                },
                [
                  h('input', {
                    staticClass: 'fit',
                    ...
                    on: cache(this, 'topIn', {
                      input: evt => {
                        this.__updateErrorIcon(
                          this.__onEditorChange(evt) === true
                        );
                      },
                      change: stop,
                      blur: evt => {
                        this.__onEditorChange(evt, true) === true &&
                          this.$forceUpdate();
                  ...
                  h(QIcon, {
                    ref: 'errorIcon',
                    staticClass:
                      'q-color-picker__error-icon absolute no-pointer-events',
    ...
    __getFooter(h) {
      return h(
        ...
        {
          staticClass:
            'q-color-picker__footer relative-position overflow-hidden'
        },
        [
          h(
            QTabs,
            ...
            h(
              ...
              [
                this.model.hex !== void 0
                  ? h('div', { staticClass: 'q-color-picker__spectrum-circle' })
                  : null
              ]
            )
          ]
                  ...
                  [
                    h(QSlider, {
                      ...
                      on: cache(this, 'alphaSlide', {
                        ...
                        change: value =>
                          this.__onNumericChange(value, 'a', 100, void 0, true)
                      })
                    })
                  ]
                )
        ...
        h('div', { staticClass: 'row items-center no-wrap' }, [
          ...
          h(QSlider, {
            ...
            on: cache(this, 'rSlide', {
              ...
              change: value =>
                this.__onNumericChange(value, 'r', 255, void 0, true)
            })
          }),
          h('input', {
            ...
            on: cache(this, 'rIn', {
              input: evt =>
                this.__onNumericChange(evt.target.value, 'r', 255, evt),
              change: stop,
              blur: evt =>
                this.__onNumericChange(evt.target.value, 'r', 255, evt, true)
            })
          })
        ]),
        ...
        h('div', { staticClass: 'row items-center no-wrap' }, [
          ...
          h(QSlider, {
            ...
            on: cache(this, 'gSlide', {
              ...
              change: value =>
                this.__onNumericChange(value, 'g', 255, void 0, true)
            })
          }),
          h('input', {
            ...
            on: cache(this, 'gIn', {
              input: evt =>
                this.__onNumericChange(evt.target.value, 'g', 255, evt),
              change: stop,
              blur: evt =>
                this.__onNumericChange(evt.target.value, 'g', 255, evt, true)
            })
          })
        ]),
        ...
        h('div', { staticClass: 'row items-center no-wrap' }, [
          ...
          h(QSlider, {
            ...
            on: cache(this, 'bSlide', {
              ...
              change: value =>
                this.__onNumericChange(value, 'b', 255, void 0, true)
            })
          }),
          h('input', {
            ...
            on: cache(this, 'bIn', {
              input: evt =>
                this.__onNumericChange(evt.target.value, 'b', 255, evt),
              change: stop,
              blur: evt =>
                this.__onNumericChange(evt.target.value, 'b', 255, evt, true)
            })
          })
        ]),
        ...
        this.hasAlpha === true
          ? h('div', { staticClass: 'row items-center no-wrap' }, [
              ...
              h('input', {
                ...
                on: cache(this, 'aIn', {
                  input: evt =>
                    this.__onNumericChange(evt.target.value, 'a', 100, evt),
                  change: stop,
                  blur: evt =>
                    this.__onNumericChange(
                      evt.target.value,
                      'a',
                      100,
                      evt,
    ...
    __getPaletteTab(h) {
      return [
        h(
          ...
          this.computedPalette.map(color =>
            h('div', {
              staticClass: 'q-color-picker__cube col-auto',
              style: { backgroundColor: color },
              on:
                this.editable === true
                  ? cache(this, 'palette#' + color, {
                      click: () => {
    ...
    __onNumericChange(value, formatModel, max, evt, change) {
      ...
      if (
        evt !== void 0 &&
        change !== true &&
        evt.target.selectionEnd !== void 0
      ) {
