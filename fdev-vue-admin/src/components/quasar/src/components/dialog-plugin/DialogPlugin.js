...
export default Vue.extend({
  ...
  computed: {
    ...
    okDisabled() {
      if (this.prompt !== void 0) {
        return (
          this.prompt.isValid !== void 0 &&
          this.prompt.isValid(this.prompt.model) !== true
        );
      }
      if (this.options !== void 0) {
        return (
          this.options.isValid !== void 0 &&
    ...
    okProps() {
      return {
        ...
        ...(Object(this.ok) === this.ok
          ? Object.assign({ plain: true }, this.ok)
          : { plain: true }),
    ...
    cancelProps() {
      return {
        ...
        ...(Object(this.cancel) === this.cancel
          ? Object.assign({ plain: true }, this.cancel)
          : { plain: true })
      };
    }
  },
  ...
  render(h) {
    ...
    this.title && child.push(this.getSection(h, 'q-dialog__title row justify-center', this.title));
    ...
    this.message &&
      child.push(this.getSection(h, 'q-dialog__message', this.message));
