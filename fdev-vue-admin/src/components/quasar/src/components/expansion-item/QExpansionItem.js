...
export default Vue.extend({
  ...
  computed: {
      ...
      return this.expandedIcon !== void 0 && this.showing === true
        ...
        : this.expandIcon ||
            this.$q.iconSet.expansionItem[
              this.denseToggle === true ? 'denseIcon' : 'icon'
            ];
    },
    ...
    activeToggleIcon() {
      return (
        this.disable !== true &&
        (this.hasRouterLink === true || this.expandIconToggle === true)
      );
    }
  },
  ...
  methods: {
    ...
    __getToggleIcon(h) {
      const data = {
        staticClass: `q-focusable relative-position cursor-pointer${
          this.denseToggle === true && this.switchToggleSide === true
            ? ' items-end'
            : ''
        }`,
      ...
      const child = [
        h(FIcon, {
          staticClass: 'q-expansion-item__toggle-icon text-gery-3',
          class:
            this.showing === true
    ...
    __getHeader(h) {
      ...
      if (this.$scopedSlots.header !== void 0) {
        ...
        this.icon &&
          child[this.switchToggleSide === true ? 'push' : 'unshift'](
            h(
              QItemSection,
              {
                props: {
      ...
      if (this.isClickable === true) {
        ...
        this.hasRouterLink === true &&
          Object.assign(data.props, this.routerLinkProps);
      }
