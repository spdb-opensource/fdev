...
export default Vue.extend({
  ...
  computed: {
    ...
    classes() {
      return {
        ...
        'q-field--highlighted_shadow': this.focused === true && !this.hasError,
        ...
        'q-field--with-bottom':
          this.hideBottomSpace !== true && this.shouldRenderBottom === true,
        'q-field--error': this.hasError,

        'q-field--readonly': this.readonly === true && this.disable !== true,
        [this.disable === true
          ? 'q-field--disabled'
          : 'q-validation-component']: true
      };
    },
    ...
    styleType() {
      ...
      if (
        (this.flat === true || this.borderless === true) &&
        this.outlined === false
      ) {
        return 'borderless';
      }
  ...
  methods: {
    ...
    __focus() {
      ...
      if (target !== void 0 && (el === null || el.id !== this.targetUid)) {
        target.hasAttribute('tabindex') === true ||
    ...
    __getContent(h) {
      ...
      this.$scopedSlots.prepend !== void 0 &&
        node.push(
          h(
            'div',
            {
      ...
      const on =
        this.$listeners['customer-click'] !== void 0
          ? {
              click: () => this.$emit('customer-click')
            }
          : {};
      node.push(
        h(
      ...
      this.$scopedSlots.append !== void 0 &&
        node.push(
          h(
            ...
            {
              staticClass:
                'items-center justify-center row q-field__marginal no-wrap',
              key: 'append',
              on: this.slotsEvents
            },
    ...
    __getInnerAppendNode(h, key, content) {
      return content === null
        ...
        : h(
            ...
            {
              staticClass:
                'q-field__append q-field__marginal justify-around row no-wrap items-center q-anchor--skip' + (key === 'error' ? ' error' : ''),
              key
            },
            content
          );
      ...
      [
        ...
        h(
          ...
          [
            ...
            this.shouldRenderBottom === true ? this.__getBottom(h) : null
          ]
        ),
  ...
  created() {
    ...
    this.controlEvents =
      this.__getControlEvents !== void 0
