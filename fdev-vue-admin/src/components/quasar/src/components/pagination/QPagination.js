  ...
  computed: {
    ...
    btnProps() {
      return {
        ...
        flat: true,
        size: this.size,
        ripple: this.ripple !== null ? this.ripple : true
      };
    },
  ...
  render(h) {
    ...
    if (this.input === true) {
      ...
      if (this.maxPages && maxPages < this.max - this.min + 1) {
        ...
        if (
          this.__ellipses &&
          pgFrom > this.min + (this.__boundaryNumbers ? 1 : 0)
        ) {
          ellipsesStart = true;
          pgFrom += 1;
        }
        ...
        if (
          this.__ellipses &&
          pgTo < this.max - (this.__boundaryNumbers ? 1 : 0)
        ) {
          ellipsesEnd = true;
          pgTo -= 1;
        }
      ...
      [
        ...
        h(
          'div',
          {
            ...
            on:
              this.input === true ? cache(this, 'stop', { input: stop }) : null
          },
          [contentMiddle]
        ),
