...
export default Vue.extend({
  ...
  methods: {
    ...
    __addFiles(e, fileList) {
      ...
      const files = processedFiles.filter(
        file => this.files.findIndex(f => file.name === f.name) === -1
      );
    ...
    __getHeader(h) {
      ...
      return [
        h(
          ...
          {
            staticClass:
              'q-uploader__header-content flex flex-center no-wrap q-gutter-xs'
          },
          [
            this.__getBtn(
              h,
            ...
            this.__getBtn(
              h,
              this.hideUploadBtn === false && this.canUpload === true,
              'upload',
              this.upload
            ),
          ...
          'div',
          {
            ...
            class: {
              'q-uploader__file--img':
                this.noThumbnails !== true && file.__img !== void 0,
