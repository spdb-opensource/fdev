<template>
  <div>
    ...
    <f-block block class="q-my-md">
      ...
      <div class="text-center">
        ...
        <fdev-btn
          ...
          :loading="globalLoading['dashboard/exportProIssues']"
          dialog
        />
      </div>
    </f-block>
    ...
    <f-block block class="q-my-md">
      <Loading
        class="q-mb-md"
        :visible="globalLoading['dashboard/queryProductionChart']"
      >
        <StackBarChart
          chartTop="10%"
          :height="chartHeight"
      ...
      <Loading :visible="globalLoading['dashboard/queryProductionTable']">
        <fdev-table
...
import StackBarChart from '@/modules/Dashboard/components/Chart/StackBarChart.vue';
export default {
  ...
  computed: {
    ...mapState('userActionSaveDashboard/productionProblems/problemsList', [
      'listModel',
      'isChartDisplay'
    ]),
    ...mapState('global', {
    ...
    ...mapState('dashboard', ['productionTable', 'export', 'productionChart']),
    chartHeight() {
  ...
  methods: {
    ...mapMutations('userActionSaveDashboard/productionProblems/problemsList', [
