<template>
  ...
  >
    ...
    <!-- <f-formitem
      ...
      profile
      label-auto
      label-class="bg-indigogrey-0 q-px-lg"
      label-style="height:43px;width:160px;line-height:14px"
      value-style="height:43px;width:234px;"
  ...
  methods: {
    ...
    applySure() {
      ...
      return Promise.all(
        ...
        async v => {
          if (this.dailogType === 'networkOpen') {
            await this.openKf();
          } else {
            await this.closeKF();
          }
