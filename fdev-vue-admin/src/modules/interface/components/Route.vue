<template>
  <div class="typora-export">
    <div id="write" class="is-node">
      <h1 id="%E8%B7%AF%E7%94%B1%E6%89%AB%E6%8F%8F%E8%A7%84%E5%88%99">
        路由扫描规则
      </h1>
      <p>Fdev接口模块在扫描vue项目路由时，依本规则执行。</p>
      <p>
        前端vue应用路由代码需符合本规则，否则接口模块无法保证路由和路由关系扫描结果的准确性。
      </p>
      <h2 id="%E8%B7%AF%E7%94%B1%E5%AE%9A%E4%B9%89">路由定义</h2>
      <p>
        前端将路由定义，路由调用，后端接口调用统一规范在项目<strong>根路径</strong>下的
        <em>project.json</em> 文件中，文件样例如下：
      </p>
      <pre
  ...
  &quot;title&quot;: &quot;财富-财富首页&quot;,
  &quot;value&quot;: &quot;wealth home&quot;,
  &quot;key&quot;: &quot;mspmk-wealth-home&quot;,
  &quot;type&quot;: &quot;web&quot;,
  &quot;tags&quot;: [&quot;wealth&quot;, &quot;home&quot;],
  &quot;name&quot;: &quot;财富-财富首页&quot;,
  &quot;cli&quot;: &quot;mbank-vue-cli@0.1.1&quot;
  &quot;context&quot;: &quot;mspmk-wealth-home&quot;
  &quot;fdev&quot;: {
    &quot;fapp&quot;: &quot;_id&quot;
   },
  &quot;deps&quot;: {
    &quot;routes&quot;: [
      {
        &quot;project&quot;: &quot;mspmk-finance-home&quot;,
        &quot;routes&quot;: [&quot;home&quot;, &quot;search&quot;],
      }
    ],
    &quot;trans&quot;: [
      {
        &quot;app&quot;: &quot;mspmk-finance-xxx&quot;,
        &quot;trans&quot;: [
          &quot;login&quot;,
          &quot;getCardInfo&quot;,
          &quot;currentUser&quot;
  ...
  &quot;routes&quot;: [ ]
      ...
      <p>将 project.json 中的 routes 字段值拆分成多个 stages，</p>
      <h3 id="stage-%E5%AE%9A%E4%B9%89">stage 定义</h3>
      <pre
        class="md-fences mock-cm"
        style="display:block;position:relative"
      ><div>{
  /**
   * @params {String} stageId: required, 场景Id
   **/
  &quot;name&quot;: &quot;首页&quot;,
  /**
   * @params {String} module: required, 场景加载容器
   **/
  &quot;module&quot;: &quot;Home&quot;,
  /**
   * @params {String} path: required, 场景加载路径
   **/
  &quot;path&quot;: &quot;./web/home/index.html&quot;,
  /**
   * @params {Object} params: optional, 自定义的场景参数 (原生初始化用)
   **/
  &quot;params&quot;: {
      &quot;x-fullscreen&quot;:&quot;yes&quot;
  },
  /**
   * @params {Array&lt;String&gt;} auth_check: optional, 鉴权
   **/
  &quot;auth_check&quot;: [],
  /**
   * @params {Object} query: optional, 跳转场景时传送参数的定义
   **/
  &quot;query&quot;: {
    &quot;title&quot;: {
      &quot;required&quot;: true
  ...
  /**
   * @params {Object|Array&lt;Object&gt;} extra: optional, 提供给原生的额外信息
   **/
  &quot;extra&quot;: {
    &quot;entry&quot;: &quot;productlist&quot;
  }
      ...
      <h2
        id="%E8%B7%AF%E7%94%B1%E4%BF%A1%E6%81%AF%E6%95%B0%E6%8D%AE%E6%A8%A1%E5%9E%8B"
      >
        路由信息数据模型
      </h2>
      <p>接口模块将扫描结果建立如下存储信息模型：</p>
      <pre
        class="md-fences mock-cm"
        style="display:block;position:relative"
      ><div>{
    &quot;name&quot;: &quot;&quot;,                  //场景名称 {String}
    &quot;module&quot;: &quot;&quot;,                //场景加载容器 {String}
    &quot;project_name&quot;:&quot;&quot;,           //项目id {String}
    &quot;branch&quot;:&quot;&quot;,                 //分支 {String}
    &quot;path&quot;: &quot;&quot;,                  //路由调用路径 {String}  
    &quot;params&quot;: {                  //自定义的场景参数 (原生初始化用){Object} params: optional,
    	 &quot;x-fullscreen&quot;:&quot;yes&quot;
        },                         
    &quot;auth_check&quot;: [],            //路由访问权限要求 {Array&lt;String&gt;}
    &quot;query&quot;: {                   //路由跳转传参，optional，{Object}
        &quot;title&quot;: {
          &quot;required&quot;: true
        }
      },
     &quot;extra&quot;: {                  //提供给原生的额外信息 optional，{Object|Array&lt;Object&gt;}
        &quot;entry&quot;: &quot;productlist&quot;
      }，
    &quot;create_time&quot; : &quot;&quot;,          //创建时间
    &quot;update_time&quot; : &quot;&quot;           //更新时间
      ...
      <h2
        id="%E8%B7%AF%E7%94%B1%E8%B0%83%E7%94%A8%E5%85%B3%E7%B3%BB%E6%95%B0%E6%8D%AE%E6%A8%A1%E5%9E%8B"
      >
        路由调用关系数据模型
      </h2>
      <pre
      ...
      ><div>{
    &quot;name&quot;: &quot;&quot;,                         //场景名称
    &quot;source_project&quot;:&quot;&quot;,                //调用项目id
    &quot;target_project&quot;:&quot;&quot;,                //路由提供项目id
    &quot;branch&quot;:&quot;&quot;,                        //分支名
    &quot;create_time&quot; : &quot;&quot;                  //录入时间
}
</div></pre>
      ...
      <ol>
        <li>
          <a
            href="http://xxx/ebank_fdev/fdev_issuses/issues/50"
            target="_blank"
            >http://xxx/ebank_fdev/fdev_issuses/issues/50
          </a>
        </li>
        <li>
          <a href="xxx/common/xndp9/vue" target="_blank"
            >xxx/common/xndp9/vue
          </a>
        </li>
      </ol>
    </div>
