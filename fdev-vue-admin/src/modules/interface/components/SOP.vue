<template>
  <div class="typora-export">
    <div id="write" class="is-node">
      <h1><a name="header-c1" class="md-header-anchor "></a>SOP接口扫描规范</h1>
      <p>
        本规范适用于纳入开发协作平台Fdev的微服务应用，如该应用在接口调用层面属于SOP接口使用方和提供方，则须遵守该接口规范，否则可能对SOP接口扫描准确性造成影响。
      </p>
      ...
      <ol>
        <li>
          <p><span>存放mapfile文件和接口报文映射文档路径：</span></p>
          <pre
            class="md-fences mock-cm"
            style="display:block;position:relative"
          >
src\main\resources\packets\sop</pre
          >
          <p>
            <span>注：</span>
            <strong
          ...
          <p>
            <span>该目录下：</span>
            <em><span>mapfile</span></em>
            <span>文件夹存放sop接口对应的mapfile文件</span>
          </p>
          <p>
            <em><span>interface</span></em>
            <span>文件夹下存放sop接口报文映射文档（xml格式）</span>
          </p>
        </li>
        <br />
        <li>
          <p>
            <span>存放接口名称映射文档、接口头信息及路径配置文档路径:</span>
          </p>
          <pre
            class="md-fences mock-cm"
            style="display:block;position:relative"
...
src\main\resources</pre
          ...
          <p>
            <span>该路径下：</span>
            <em><span>sop_alias</span></em>
            <span>.properties 配置接口别名映射</span>
          </p>
          <p>
            <em><span>sop_head</span></em>
            <span>.properties 配置接口头信息（系统头、公共头、数据头等）</span>
          </p>
          <p>
            <em><span>sop_configure</span></em>
            <span>.properties 配置sop接口文件路径</span>
          </p>
        </li>
      </ol>
      ...
      <ol>
        <li>
          <p>接口名称映射文档</p>
          <span>
k-v格式（别名=Oxxxx0），k不可重复，v可重复，扫描时取k为接口别名，取v中间四位为esb统一交易码.废弃或下线接口请及时删除。
          </span>
          <p>示例如下：</p>
          <pre
            class="md-fences mock-cm"
          ...
          >
#查询活期余额
QueryCurrentBalance=O15041</pre
          >
        </li>
        ...
        <li>
          ...
          <ul>
            <li>
              <p>文件命名：以接口别名命名，与<em>sop_alias.properties</em>中的接口别名保持一一对应关系，如<em>QueryCurrentBalance.xml</em></p>
            </li>

            <li>
              <p>文件结构：包括三部分：xml声明、请求信息、响应信息。</p>
              <p>其中**中的name应填写对应交易码，如 <em>O15041</em></p>
              <p>对sop接口使用方：表示请求信息；表示响应信息</p>
            </li>
            ...
            <li>
              <p>备注：废弃、下线接口，请及时更新对应该映射文件，且须删除样例文件。</p>
            </li>
          </ul>
        </li>
      </ol>
...
export default {
  ...
  <trans name="O15041">
    <snd>
      <keys type="com.csii.ebank.core.KeyedData">
        <item name="QueryType" type="java.lang.String" aliase="CHAXLX" />
        <item name="AcctType" type="java.lang.String" aliase="KHZHLX" />
        <item name="AcctNo" type="java.lang.String" aliase="KAHAO1" />
        <item name="CurrencyNo" type="java.lang.String" aliase="HUOBDH" />
      </keys>
    </snd>
    <rcv>
      <keys type="com.csii.ebank.core.KeyedData">
        <indexs name="LoopResult" type="com.csii.ebank.core.IndexedData" aliase="F1504">
          <keys type="com.csii.ebank.core.KeyedData">
            <item name="SavingType" type="java.lang.String" aliase="ZHHUXZ" />
            <item name="AcctNo" type="java.lang.String" aliase="ZHANGH" />
            <item name="CurrencyNo" type="java.lang.String" aliase="HUOBDH" />
          </keys>
        </indexs>
      </keys>
