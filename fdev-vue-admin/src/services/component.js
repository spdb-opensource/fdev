...
/* 查看后端组件版本信息修改记录 */
export async function queryComponentRecordHis(params) {
  return request(service.fcomponent.queryComponentRecordHis, {
    method: 'POST',
    data: {
      ...params
    }
...
export async function scanHistory(params) {
  return request('/fcomponent/api/component/scanComponentHistory', {
    method: 'POST',
    data: {
      ...params
    }
