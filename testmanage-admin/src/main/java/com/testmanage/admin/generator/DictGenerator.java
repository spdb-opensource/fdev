package com.testmanage.admin.generator;
...
public class DictGenerator {
    ...
    public static void main(String[] args) {
        ...
        String[] dict_filenames = {
                "/dict_admin.properties"};
        String targetName = "../util/Dict.java";
        try {
            System.out.println("begin generated the ../util/Dict.java file  .....");
            ...
            prt.println("package com.testmanage.admin.util;");
            prt.println("/**");
            prt.println(" * FTMS系统——公共字典文件");
