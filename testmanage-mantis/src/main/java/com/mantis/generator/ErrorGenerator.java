...
public class ErrorGenerator {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String dictName = "/"
					+ com.mantis.generator.ErrorGenerator.class.getName().replace('.', '/');

			java.net.URL outUrl1 = com.mantis.generator.ErrorGenerator.class.getResource(dictName
					+ ".class");
			...
			prt.println(" */ ");
			prt.println("package com.mantis.dict;");
