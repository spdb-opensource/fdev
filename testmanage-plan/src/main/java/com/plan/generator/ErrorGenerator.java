...
public class ErrorGenerator {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String dictName = "/"
					+ com.plan.generator.ErrorGenerator.class.getName().replace('.', '/');

			java.net.URL outUrl1 = com.plan.generator.ErrorGenerator.class.getResource(dictName
					+ ".class");
			...
			prt.println(" */ ");
			prt.println("package com.plan.dict;");
