package com.manager.ftms.generator;
...
public class DictGenerator {
    private static Logger logger = LoggerFactory.getLogger(DictGenerator.class);
    /**
    ...
    public static void main(String[] args) {
        ...
        String[] dict_filenames = {              
                "/config/dict-testcase.properties"};
        ...
        try {
            ...
            prt.println("package com.manager.ftms.util;");
            prt.println("/**");
